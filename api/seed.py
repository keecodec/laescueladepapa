...
def seed_database():
    ...
    if not conn:
        logger.error("Cannot connect to database for seed")
        return
    ...
    logger.info("Upgrading curriculum data")
    try:
        ...
        if prof_res and stu_res:
            ...
            logger.info("Loading schedule variations")
            schedules_data = [
                # Lundi
        ...
        logger.error("Seed insertion error")
